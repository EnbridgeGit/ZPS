...
*
************************************************************************
* 97/10/06 md7140 Amts in Transaction $ (wkg001) s/b CO $ (WKG001)
************************************************************************
...
TOP-OF-PAGE.
  ...
  WRITE: / TEXT-RPT, SY-REPID, 115 TEXT-010 COLOR COL_GROUP,
       225 TEXT-DTE, SY-DATUM, TEXT-AMP, SY-UZEIT.
  WRITE: / TEXT-CLT UNDER TEXT-RPT, SY-MANDT UNDER SY-REPID,
           TEXT-PGE UNDER TEXT-DTE, SY-PAGNO.
  WRITE: / TEXT-VRS UNDER TEXT-RPT, P_VERS1.
  WRITE: / TEXT-CVR UNDER TEXT-RPT, P_VERS2.

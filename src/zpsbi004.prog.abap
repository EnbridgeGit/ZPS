REPORT ZPSBI004 MESSAGE-ID ZS LINE-SIZE 80 LINE-COUNT 59.
***********************************************************************
*       Owner: Centra/Union                                           *
*  Programmer: Yaxin Veliz - OmniLogic Systems Group (Toronto)        *
*        Date: January 8th, 1996                                      *
*  Request ID: Emergency BDC for PS (Requested by Howared Allison)    *
*                                                                     *
* This BDC program will delete interest calculation profiles for      *
* selected projects.                                                  *
***********************************************************************
...
DATA:  BDCCNT TYPE I,                 "BDC counter
       ...
       TMP_ZSCHM LIKE PRPS-ZSCHM,     "Temporary Costing Sheet
...
PARAMETERS: P_SEARCH(1) TYPE C DEFAULT '9' OBLIGATORY MODIF ID ABC.
PARAMETERS: P_ZSCHM LIKE PRPS-ZSCHM MODIF ID ABC.
...
*    DO TMP_CNT TIMES.
        PERFORM BDC_SCREEN USING 'SAPLCJWB'   '0406'.
        PERFORM BDC_FIELD  USING 'PRPS-ZSCHM'  TMP_ZSCHM.
